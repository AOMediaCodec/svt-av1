...
| **CDEFMode** | --cdef-mode | [0-5] | -1 | CDEF Mode, 0: OFF, 1-5: ON with 2,4,8,16,64 step refinement, -1: DEFAULT|
...
| **SpatialSSEfl** | --enable-spatial-sse-fl | [0,1] | -1 | Enable spatial sse full loop, 0 = OFF, 1 = ON, -1 = DEFAULT|
| **Subpel** | --subpel | [0,1] | -1 | Enable subpel, 0 = OFF, 1 = ON, -1 = DEFAULT|
...
| **PruneUnipredMe** | --enable-prune-unipred-me | [0,1] | -1 | Enable prune unipred at me, 0 = OFF, 1 = ON, -1 = DEFAULT|
| **PruneRefRecPart** | --enable-prune-ref-rec-part | [0,1] | -1 | Enable prune prune ref frame for rec partitions, 0 = OFF, 1 = ON, -1 = DEFAULT|
...
| **CombineClass12** | --enable-class-12 | [0,1] | -1 | Enable combine Mode decision Classes 1 and 2 (inter classes), 0 = OFF, 1 = ON, -1 = DEFAULT|
| **EdgeSkipAngleIntra** | --enable-intra-edge-skp | [0,1] | -1 | Enable skip angle intra based on edge, 0 = OFF, 1 = ON, -1 = DEFAULT|
...
| **Obmc** | --enable-obmc | [0,1] | 1 | Enable OBMC(0: OFF, 1: ON[default]) |
| **RDOQ** | --enable-rdoq | [0,1] | -1 | Enable RDOQ, 0 = OFF, 1 = ON, -1 = DEFAULT |
| **FilterIntra** | --enable-filter-intra | [0,1] | 1 | Enable filter intra prediction mode (0: OFF, 1: ON [default]) |
...
| **EnableAltRefs** | --enable-altrefs | [0,1] | 1 | Enable automatic alt reference frames(0: OFF, 1: ON[default]) |
