...
| **ChromaMode** | -chroma-mode | [0-3, -1 for auto] | Auto | Chroma Mode <br>-1 = AUTO<br>0 = Full chroma search @ MD  <br>1 = Fast chroma search @ MD  <br>2 = Chroma blind @ MD + CFL @ EP <br>3 = Chroma blind @ MD + no CFL @ EP |
