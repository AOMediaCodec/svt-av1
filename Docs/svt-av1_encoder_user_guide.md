...
| **CDEF** | -cdef | [0/1, -1 for default] | -1 | Enable Constrained Directional Enhancement Filter (CDEF), 0 = OFF, 1 = ON, -1 = DEFAULT|
| **CDEFFilterMode** | -cdef-filter-mode | [0-5, -1 for default] | -1 | CDEF Filter Mode, 0: OFF, 1-5: 2,4,8,16,64 step refinement, -1: DEFAULT|
