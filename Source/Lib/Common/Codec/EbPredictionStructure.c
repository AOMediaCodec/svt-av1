 ...
 ************************************************/
static PredictionStructureConfig PredictionStructureConfigArray[] = {
    {1,     flat_pred_struct},
    ...
    uint32_t                         baseLayerSwitchMode)
{
    ...
    *predictionStructureGroupDblPtr = predictionStructureGroupPtr;
    ...
    EB_MALLOC(PredictionStructureConfigEntry*, cur_four_level_hierarchical_pred_struct, sizeof(four_level_hierarchical_pred_struct), EB_N_PTR);
    EB_MALLOC(PredictionStructureConfigEntry*, cur_five_level_hierarchical_pred_struct, sizeof(five_level_hierarchical_pred_struct), EB_N_PTR);
    EB_MEMCPY(cur_four_level_hierarchical_pred_struct, four_level_hierarchical_pred_struct, sizeof(four_level_hierarchical_pred_struct));
    EB_MEMCPY(cur_five_level_hierarchical_pred_struct, five_level_hierarchical_pred_struct, sizeof(five_level_hierarchical_pred_struct));
    PredictionStructureConfigArray[4-1].entry_array = cur_four_level_hierarchical_pred_struct;
    PredictionStructureConfigArray[5-1].entry_array = cur_five_level_hierarchical_pred_struct;
