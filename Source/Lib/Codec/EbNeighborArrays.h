...
#define NEIGHBOR_ARRAY_UNIT_TOP_AND_LEFT_ONLY_MASK      (NEIGHBOR_ARRAY_UNIT_LEFT_MASK | NEIGHBOR_ARRAY_UNIT_TOP_MASK)
     ...
     *************************************************/
    INLINE uint32_t get_neighbor_array_unit_left_index32(
        NeighborArrayUnit32_t *na_unit_ptr,
        uint32_t               loc_y) {
        return (loc_y >> na_unit_ptr->granularityNormalLog2);
    }

    INLINE uint32_t get_neighbor_array_unit_left_index(
     ...
     *************************************************/
    INLINE uint32_t get_neighbor_array_unit_top_index32(
        NeighborArrayUnit32_t *na_unit_ptr,
        uint32_t               loc_x) {
        return (loc_x >> na_unit_ptr->granularityNormalLog2);
    }

    INLINE uint32_t get_neighbor_array_unit_top_index(
        NeighborArrayUnit_t *na_unit_ptr,
        uint32_t               loc_x) {
        return (loc_x >> na_unit_ptr->granularityNormalLog2);
    }
