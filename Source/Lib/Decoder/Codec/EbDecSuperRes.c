...
void av1_superres_upscale(Av1Common *cm, FrameHeader *frm_hdr, SeqHeader *seq_hdr,
    ...
    memset(recon_picture_src->buffer_y, 0, recon_picture_src->luma_size * bytesPerPixel);
    memset(recon_picture_src->buffer_cb, 0, recon_picture_src->chroma_size * bytesPerPixel);
    memset(recon_picture_src->buffer_cr, 0, recon_picture_src->chroma_size * bytesPerPixel);
