    ...
    for (;;) {
        ...
        case RC_INPUT:
            ...
            if (scs_ptr->static_config.rate_control_mode == 0) {
                ...
                if (scs_ptr->static_config.enable_qp_scaling_flag &&
                ...
                else if (scs_ptr->static_config.use_fixed_qindex_offsets == 1) {
                    ...
                    chroma_qindex =
                        CLIP3(quantizer_to_qindex[scs_ptr->static_config.min_qp_allowed],
                            quantizer_to_qindex[scs_ptr->static_config.max_qp_allowed],
                            chroma_qindex);
...
/*
                    printf(
                        ...
                        "Index = %d, Picture QP = %d, Picture Qindex = %d\n",
