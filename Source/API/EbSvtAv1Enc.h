...
EbErrorType svt_av1_enc_stream_header(EbComponentType *    svt_enc_component,
...
EbErrorType svt_av1_enc_stream_header_release(EbBufferHeaderType *stream_header_ptr);
...
EbErrorType svt_av1_enc_eos_nal(EbComponentType *    svt_enc_component,
                                      EbBufferHeaderType **output_stream_ptr);
...
EbErrorType svt_av1_enc_send_picture(EbComponentType *   svt_enc_component,
...
EbErrorType svt_av1_enc_get_packet(EbComponentType *    svt_enc_component,
...
EbErrorType svt_av1_get_recon(EbComponentType *   svt_enc_component,
                                    EbBufferHeaderType *p_buffer);
...
/* STEP 7: Deconstruct encoder handler.
     ...
     * Parameter:
     * @ *svt_enc_component  Encoder handler. */
EbErrorType svt_av1_enc_deinit_handle(EbComponentType *svt_enc_component);
