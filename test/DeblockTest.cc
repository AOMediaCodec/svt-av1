...
extern "C" {
void eb_aom_lpf_vertical_6_sse2(uint8_t *s, int32_t p, const uint8_t *blimit,
...
const HbdLpfTestParam kHbdLoop8Test6[] = {
    make_tuple(&eb_aom_highbd_lpf_horizontal_4_sse2,
               &eb_aom_highbd_lpf_horizontal_4_c, 8),
    make_tuple(&eb_aom_highbd_lpf_vertical_4_sse2,
               &eb_aom_highbd_lpf_vertical_4_c, 8),
    make_tuple(&eb_aom_highbd_lpf_horizontal_6_sse2,
               &eb_aom_highbd_lpf_horizontal_6_c, 8),
    make_tuple(&eb_aom_highbd_lpf_horizontal_8_sse2,
               &eb_aom_highbd_lpf_horizontal_8_c, 8),
    make_tuple(&eb_aom_highbd_lpf_horizontal_14_sse2,
               &eb_aom_highbd_lpf_horizontal_14_c, 8),
    make_tuple(&eb_aom_highbd_lpf_vertical_6_sse2,
               &eb_aom_highbd_lpf_vertical_6_c, 8),
    make_tuple(&eb_aom_highbd_lpf_vertical_8_sse2,
               &eb_aom_highbd_lpf_vertical_8_c, 8),
    make_tuple(&eb_aom_highbd_lpf_vertical_14_sse2,
               &eb_aom_highbd_lpf_vertical_14_c, 8),
    make_tuple(&eb_aom_highbd_lpf_horizontal_4_sse2,
               &eb_aom_highbd_lpf_horizontal_4_c, 10),
    make_tuple(&eb_aom_highbd_lpf_vertical_4_sse2,
               &eb_aom_highbd_lpf_vertical_4_c, 10),
    make_tuple(&eb_aom_highbd_lpf_horizontal_6_sse2,
               &eb_aom_highbd_lpf_horizontal_6_c, 10),
    make_tuple(&eb_aom_highbd_lpf_horizontal_8_sse2,
               &eb_aom_highbd_lpf_horizontal_8_c, 10),
    make_tuple(&eb_aom_highbd_lpf_horizontal_14_sse2,
               &eb_aom_highbd_lpf_horizontal_14_c, 10),
    make_tuple(&eb_aom_highbd_lpf_vertical_6_sse2,
               &eb_aom_highbd_lpf_vertical_6_c, 10),
    make_tuple(&eb_aom_highbd_lpf_vertical_8_sse2,
               &eb_aom_highbd_lpf_vertical_8_c, 10),
    make_tuple(&eb_aom_highbd_lpf_vertical_14_sse2,
               &eb_aom_highbd_lpf_vertical_14_c, 10),
    make_tuple(&eb_aom_highbd_lpf_horizontal_4_sse2,
               &eb_aom_highbd_lpf_horizontal_4_c, 12),
    make_tuple(&eb_aom_highbd_lpf_vertical_4_sse2,
               &eb_aom_highbd_lpf_vertical_4_c, 12),
    make_tuple(&eb_aom_highbd_lpf_horizontal_6_sse2,
               &eb_aom_highbd_lpf_horizontal_6_c, 12),
    make_tuple(&eb_aom_highbd_lpf_horizontal_8_sse2,
               &eb_aom_highbd_lpf_horizontal_8_c, 12),
    make_tuple(&eb_aom_highbd_lpf_horizontal_14_sse2,
               &eb_aom_highbd_lpf_horizontal_14_c, 12),
    make_tuple(&eb_aom_highbd_lpf_vertical_14_sse2,
               &eb_aom_highbd_lpf_vertical_14_c, 12),
    make_tuple(&eb_aom_highbd_lpf_vertical_6_sse2,
               &eb_aom_highbd_lpf_vertical_6_c, 12),
    make_tuple(&eb_aom_highbd_lpf_vertical_8_sse2,
               &eb_aom_highbd_lpf_vertical_8_c, 12)};

const LdbLpfTestParam kLoop8Test6[] = {
    make_tuple(&eb_aom_lpf_horizontal_4_sse2, &eb_aom_lpf_horizontal_4_c, 8),
    make_tuple(&eb_aom_lpf_horizontal_8_sse2, &eb_aom_lpf_horizontal_8_c, 8),
    make_tuple(&eb_aom_lpf_horizontal_6_sse2, &eb_aom_lpf_horizontal_6_c, 8),
    make_tuple(&eb_aom_lpf_horizontal_14_sse2, &eb_aom_lpf_horizontal_14_c, 8),
    make_tuple(&eb_aom_lpf_vertical_4_sse2, &eb_aom_lpf_vertical_4_c, 8),
    make_tuple(&eb_aom_lpf_vertical_8_sse2, &eb_aom_lpf_vertical_8_c, 8),
    make_tuple(&eb_aom_lpf_vertical_14_sse2, &eb_aom_lpf_vertical_14_c, 8),
};
/* clang-format on */
